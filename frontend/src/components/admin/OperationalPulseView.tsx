                ...
                <div className="lg:col-span-2 space-y-6">
                    <div className="shine-card p-8">
                        <div className="flex justify-between items-center mb-8">
                            ...
                            <span className="text-[9px] bg-emerald-50 dark:bg-emerald-500/10 text-emerald-600 px-2.5 py-1 rounded-lg font-extrabold uppercase tracking-[0.2em] border border-emerald-100 dark:border-emerald-500/20">Live Intelligence</span>
                        </div>
                            ...
                            {[
                                ...
                                <div key={i} className="p-4 bg-slate-50 dark:bg-slate-900/50 rounded-2xl border border-slate-100 dark:border-slate-800 group hover:border-orange-200 transition-all">
                                    ...
                                    <div className="flex items-center gap-2 mb-1">
                                        <span className="text-xl font-extrabold text-slate-800 dark:text-white font-poppins">{item.val}</span>
                                        <TrendingUp size={14} className="text-emerald-500" />
                                    </div>
                                    <span className="text-[9px] font-extrabold text-emerald-600 uppercase tracking-tighter">{item.status}</span>
                                </div>
                            ))}
                        </div>
                    </div>
                            ...
                            {[
                                ...
                                <div key={i} className="space-y-2">
                                    <div className="flex justify-between items-center">
                                        ...
                                        <span className="text-[10px] text-slate-400 font-extrabold uppercase tracking-widest">{item.density}% Utilization</span>
                                    </div>
                ...
                <div className="space-y-6">
                    <div className="bg-[#003d4d] p-8 rounded-[20px] shadow-xl text-white relative overflow-hidden group">
                        ...
                        <div className="space-y-4 relative z-10">
                            ...
                            <button className="w-full py-3.5 bg-orange-500 text-white rounded-xl text-[10px] font-extrabold uppercase tracking-widest shadow-lg shadow-orange-500/20 hover:bg-orange-600 transition-all">Launch Talent Bounty</button>
                        </div>
                    </div>

                    <div className="shine-card p-6">
                        <h3 className="text-[10px] font-extrabold text-slate-400 uppercase tracking-[0.2em] mb-6">Platform Vitality</h3>
                        <div className="space-y-5">
                            <div className="flex items-center justify-between p-3 bg-slate-50 dark:bg-slate-900/50 rounded-xl border border-slate-100 dark:border-slate-800">
                                ...
                                <span className="text-xs font-extrabold text-emerald-500 font-mono">99.99%</span>
                            </div>
                            <div className="flex items-center justify-between p-3 bg-slate-50 dark:bg-slate-900/50 rounded-xl border border-slate-100 dark:border-slate-800">
                                <div className="flex items-center gap-3">
                                ...
                                <span className="text-[10px] font-extrabold text-blue-500 uppercase tracking-widest">Active</span>
                            </div>
                        </div>
                    </div>
                </div>
