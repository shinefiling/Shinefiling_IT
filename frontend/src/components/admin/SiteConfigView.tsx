        ...
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="shine-card p-6 flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div className="flex gap-3">
                    <button className="flex items-center gap-2 px-6 py-2.5 bg-orange-500 text-white text-[10px] font-extrabold uppercase tracking-widest rounded-xl shadow-lg shadow-orange-500/20 hover:bg-orange-600 transition-all"><Save size={18} /> Save All Changes</button>
                </div>
            </div>
                ...
                <div className="space-y-6">
                    <div className="shine-card p-8">
                        ...
                        <div className="space-y-5">
                            <div>
                                <label className="text-[10px] font-extrabold text-slate-400 uppercase tracking-widest mb-2 block">Primary Brand Color</label>
                            ...
                            <div>
                                <label className="text-[10px] font-extrabold text-slate-400 uppercase tracking-widest mb-2 block">Platform Logo Asset</label>
                    ...
                    <div className="shine-card p-8">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                <label className="text-[10px] font-extrabold text-slate-400 uppercase tracking-widest mb-2 block">Commission (%)</label>
                            ...
                            <div>
                                <label className="text-[10px] font-extrabold text-slate-400 uppercase tracking-widest mb-2 block">Payout Fee (₹)</label>
                ...
                <div className="space-y-6">
                    ...
                    <div className="shine-card p-8">
                        ...
                        <div className="space-y-4">
                            <div>
                                <label className="text-[10px] font-extrabold text-slate-400 uppercase tracking-widest mb-2 block">Latest Update Content</label>
                                <textarea 
                                    id="newsContent"
                            ...
                            <button 
                                ...
                                className="w-full py-3 bg-[#003d4d] text-white text-[10px] font-extrabold uppercase tracking-widest rounded-xl hover:bg-[#002d38] transition-all shadow-md"
                            >
                                Publish Update
                            </button>
                        </div>
                    ...
                    <div className="bg-[#003d4d] p-8 rounded-[20px] shadow-xl text-white relative overflow-hidden group">
                        ...
                        <button className="w-full py-3 bg-white/10 hover:bg-white/20 rounded-xl text-[10px] font-extrabold uppercase tracking-widest transition-all border border-white/10">Purge Global CDN Cache</button>
                    </div>
                </div>
            </div>
        </div>
