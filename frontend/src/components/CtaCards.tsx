                ...
                <div className="grid md:grid-cols-2 gap-6">
                    ...
                    >
                        <div className="w-2/3 sm:w-2/5 group-hover:scale-110 transition-transform duration-500">
                            <img src={`${import.meta.env.BASE_URL}3655442-removebg-preview.png`} alt="IT Expert" className="w-full h-auto" />
                        </div>
                    ...
                    >
                        ...
                        <div className="w-2/3 sm:w-2/5 group-hover:scale-110 transition-transform duration-500">
                            <img src={`${import.meta.env.BASE_URL}6203116-removebg-preview.png`} alt="Hire Talent" className="w-full h-auto" />
                        </div>
                    </motion.div>
                </div>
            </div>
